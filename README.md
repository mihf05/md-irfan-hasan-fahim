...
Software Developer with expertise in architecting high-scale, production-grade systems. Lead Developer of Kanect (SaaS & Real-time infrastructure) and National Award-winner in Computer Vision. Active contributor to open-source projects (like MRT Buddy). Proficient in building highly available SaaS ecosystems and real-time automation for complex business needs.
</div>
...
```
🏆 awards/
├── 🏅 9th Place - Freshers Coding Challenge (Summer 2025)
